...
> 基于节点的 2D 游戏资产生产工作流平台 — 组合、生成、处理、导出。

---

## 概述

SpriteFlow 是一个 **DAG 节点流水线平台**，将 AI 图片生成、视频生成、图片后处理编排为自动化资产生产工作流。面向需要批量生产精灵图、角色变体、精灵表、特效的 **2D 游戏开发者**。
